            ...
            <div className="container" style={{ padding: '6rem 2rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
                    <motion.span
                        ...
                        style={{ color: 'var(--color-rose-gold)', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', fontSize: '0.9rem' }}
                    >
                        The Scent Gallery
                    </motion.span>
                    <motion.h1
                            ...
                            <Link to={`/product/${product.id}`} style={{ textDecoration: 'none' }}>
                                ...
                                >
                                    ...
                                    <div style={{ padding: '2.5rem', textAlign: 'center' }}>
                                        ...
                                        <h3 style={{ fontSize: '1.8rem', marginTop: '0.5rem', marginBottom: '0.75rem', color: 'var(--color-white)', fontFamily: 'var(--font-display)' }}>{product.name}</h3>
                                        <p style={{ fontSize: '1.2rem', color: 'rgba(255, 255, 255, 0.65)', marginBottom: '2rem', fontWeight: 500 }}>{product.price}</p>
